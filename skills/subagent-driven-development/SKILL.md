...
Maven spawns sub-agents for: parallel creative formats (square + vertical + horizontal in one campaign), multi-platform variants (Meta + Google + LinkedIn copy of the same offer), and competitor-research crawls. Sub-agents stay in their lane — content-creator owns ad copy, image-generator owns static creative, video-editor owns video — and never cross. Coordination happens through Maven's main thread.
