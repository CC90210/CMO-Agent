...
bot.on('message', async (msg) => {
    ...
    if (text === '/start' || text === '/help') {
        return bot.sendMessage(chatId, [
            ...
            '  "Generate 5 ideas about primary retainer rev share" → script_ideation',
            '  "Post a tweet about today\'s primary retainer win" → drafts via critic, asks approval',
    ...
    if (text === '/pulses') {
        ...
        for (const t of targets) {
            ...
            if (t.agent === 'atlas') {
                ...
                const conc = rev.top_client_concentration_pct ?? '?';
